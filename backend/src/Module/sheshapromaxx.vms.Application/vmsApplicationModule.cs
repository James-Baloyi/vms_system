...
namespace sheshapromaxx.vms.Application
{
    ...
    public class vmsApplicationModule : SheshaSubModule<vmsModule>
    {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore().CreateControllersForAppServices(
               typeof(vmsApplicationModule).Assembly,
               moduleName: "vms",
                useConventionalHttpVerbs: true);

            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(vmsModule).GetAssembly()
                 );

            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(vmsApplicationModule).GetAssembly()
                 );
        }
    }
}
