...
namespace sheshapromaxx.vms.Common.Authorization
{
    /// <summary>
    /// vms Permission checker
    /// </summary>
    public class vmsPermissionChecker : ICustomPermissionChecker, IvmsPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public vmsPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
