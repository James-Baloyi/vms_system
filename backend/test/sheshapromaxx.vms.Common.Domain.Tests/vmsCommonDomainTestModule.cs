...
using sheshapromaxx.vms.Tests.DependencyInjection;
using Shesha;
...
namespace sheshapromaxx.vms.Common.Tests
{
    [DependsOn(
        typeof(vmsModule),
    ...
    public class vmsCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public vmsCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
